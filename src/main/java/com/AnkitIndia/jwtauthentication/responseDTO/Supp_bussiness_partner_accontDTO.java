...
public class Supp_bussiness_partner_accontDTO {
	...
	public String getParty_bankacc() {
		return party_bankacc;
	}

	public void setParty_bankacc(String party_bankacc) {
		this.party_bankacc = party_bankacc;
	}
