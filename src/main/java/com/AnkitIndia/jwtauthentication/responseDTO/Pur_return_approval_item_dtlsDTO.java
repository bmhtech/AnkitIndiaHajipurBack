...
public class Pur_return_approval_item_dtlsDTO {
	...
	public double getMatwt() {
		return matwt;
	}

	public void setMatwt(double matwt) {
		this.matwt = matwt;
	}
	...
	public String getAccnorms() {
		return accnorms;
	}

	public void setAccnorms(String accnorms) {
		this.accnorms = accnorms;
	}
