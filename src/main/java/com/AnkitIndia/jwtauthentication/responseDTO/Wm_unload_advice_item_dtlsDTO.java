...
public class Wm_unload_advice_item_dtlsDTO {
...
//	private int s_qty;
	...
	public String getWearhouse_name() {
		return wearhouse_name;
	}

	public void setWearhouse_name(String wearhouse_name) {
		this.wearhouse_name = wearhouse_name;
	}
