...
public class Item_group_master_stk_trans_purDTO {
	...
	public Item_group_master_stk_trans_purDTO() {
		super();
	}

	public Item_group_master_stk_trans_purDTO(Long id, String item_group_code, String item_group_id, String company_id,
	...
	public String toString() {
		return "Item_group_master_stk_trans_purDTO [id=" + id + ", item_group_code=" + item_group_code
				+ ", item_group_id=" + item_group_id + ", company_id=" + company_id + ", item_total_gl_ac="
				+ item_total_gl_ac + ", discount_gl_ac=" + discount_gl_ac + ", amt_after_deduction_gl_ac=" + amt_after_deduction_gl_ac + ", post_tax_amt_gl_ac="
