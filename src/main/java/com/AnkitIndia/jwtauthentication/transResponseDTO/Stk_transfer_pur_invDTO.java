...
public class Stk_transfer_pur_invDTO {
	...
	public String getSend_business_unit() {
		return send_business_unit;
	}

	public void setSend_business_unit(String send_business_unit) {
		this.send_business_unit = send_business_unit;
	}

	public Stk_transfer_pur_invDTO() {
		super();
	}

	public Stk_transfer_pur_invDTO(Long id, String stk_trans_pur_inv_id, String stk_trans_pur_inv_no,
			String stk_trans_pur_inv_date, String business_unit, String business_unitname, String created_by,
			String vehicle_id, String vehicle_no, String remarks, double item_total, String item_total_gl_ac,
			double discount, String discount_gl_ac, double qc_deduction, String qc_deduction_gl_ac, double net_amt,
			String net_amt_gl_ac, double amt_after_deduction, String amt_after_deduction_gl_ac, double add_tax,
			String add_tax_gl_ac, double post_tax_amt, String post_tax_amt_gl_ac, double other_charges,
			String other_charges_gl_ac, double payable_amt, String payable_amt_gl_ac, double add1, String add1_gl_ac,
			double add2, String add2_gl_ac, double roundoff_amt, String roundoff_gl_ac, double payable_party,
			String payable_party_gl_ac, double already_paid, String already_paid_gl_ac, double net_payable_party,
			String net_payable_party_gl_ac, String reference_id, String username, String company_id, String fin_year,
			String modified_type, LocalDateTime inserted_on, String inserted_by, LocalDateTime updated_on,
			String updated_by,String send_business_unit) {
		super();
		this.id = id;
		this.stk_trans_pur_inv_id = stk_trans_pur_inv_id;
		this.stk_trans_pur_inv_no = stk_trans_pur_inv_no;
		this.stk_trans_pur_inv_date = stk_trans_pur_inv_date;
	...
	public String getStk_trans_pur_inv_id() {
		return stk_trans_pur_inv_id;
	}

	public void setStk_trans_pur_inv_id(String stk_trans_pur_inv_id) {
		this.stk_trans_pur_inv_id = stk_trans_pur_inv_id;
	}

	public String getStk_trans_pur_inv_no() {
		return stk_trans_pur_inv_no;
	}

	public void setStk_trans_pur_inv_no(String stk_trans_pur_inv_no) {
		this.stk_trans_pur_inv_no = stk_trans_pur_inv_no;
	}

	public String getStk_trans_pur_inv_date() {
		return stk_trans_pur_inv_date;
	}

	public void setStk_trans_pur_inv_date(String stk_trans_pur_inv_date) {
		this.stk_trans_pur_inv_date = stk_trans_pur_inv_date;
	}
	...
	public String toString() {
		return "Stk_transfer_pur_invDTO [id=" + id + ", stk_trans_pur_inv_id=" + stk_trans_pur_inv_id
				+ ", stk_trans_pur_inv_no=" + stk_trans_pur_inv_no + ", stk_trans_pur_inv_date="
				+ stk_trans_pur_inv_date + ", business_unit=" + business_unit + ", business_unitname="
				+ business_unitname + ", created_by=" + created_by + ", vehicle_id=" + vehicle_id + ", vehicle_no="
				+ vehicle_no + ", remarks=" + remarks + ", item_total=" + item_total + ", item_total_gl_ac="
				+ item_total_gl_ac + ", discount=" + discount + ", discount_gl_ac=" + discount_gl_ac + ", qc_deduction="
				+ qc_deduction + ", qc_deduction_gl_ac=" + qc_deduction_gl_ac + ", net_amt=" + net_amt
				+ ", net_amt_gl_ac=" + net_amt_gl_ac + ", amt_after_deduction=" + amt_after_deduction
				+ ", amt_after_deduction_gl_ac=" + amt_after_deduction_gl_ac + ", add_tax=" + add_tax
				+ ", add_tax_gl_ac=" + add_tax_gl_ac + ", post_tax_amt=" + post_tax_amt + ", post_tax_amt_gl_ac="
				+ post_tax_amt_gl_ac + ", other_charges=" + other_charges + ", other_charges_gl_ac="
				+ other_charges_gl_ac + ", payable_amt=" + payable_amt + ", payable_amt_gl_ac=" + payable_amt_gl_ac
				+ ", add1=" + add1 + ", add1_gl_ac=" + add1_gl_ac + ", add2=" + add2 + ", add2_gl_ac=" + add2_gl_ac
				+ ", roundoff_amt=" + roundoff_amt + ", roundoff_gl_ac=" + roundoff_gl_ac + ", payable_party="
				+ payable_party + ", payable_party_gl_ac=" + payable_party_gl_ac + ", already_paid=" + already_paid
				+ ", already_paid_gl_ac=" + already_paid_gl_ac + ", net_payable_party=" + net_payable_party
				+ ", net_payable_party_gl_ac=" + net_payable_party_gl_ac + ", reference_id=" + reference_id
				+ ", username=" + username + ", company_id=" + company_id + ", fin_year=" + fin_year
				+ ", modified_type=" + modified_type + ", inserted_on=" + inserted_on + ", inserted_by=" + inserted_by
				+ ", updated_on=" + updated_on + ", updated_by=" + updated_by + ",send_business_unit="+send_business_unit+"]";
	}
