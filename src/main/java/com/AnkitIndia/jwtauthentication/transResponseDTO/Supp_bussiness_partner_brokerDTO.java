...
public class Supp_bussiness_partner_brokerDTO {
	...
	public Supp_bussiness_partner_brokerDTO() {
		super();
	}

	public Supp_bussiness_partner_brokerDTO(Long id, String bp_Id, String company_id, int sl_no, String ven_code_name,
			String ven_name, String basis, String based_on, double rate, String brokerage_acc, double tds_rate,
			String tds_acc) {
		super();
		this.id = id;
		this.bp_Id = bp_Id;
