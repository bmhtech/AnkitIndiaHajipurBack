...
public class Broker_master_transporterDTO {
	...
	private String trans_code_name;
	...
	public String getTrans_code_name() {
		return trans_code_name;
	}

	public void setTrans_code_name(String trans_code_name) {
		this.trans_code_name = trans_code_name;
	}
