...
public class Broker_master_vdrDTO {
	...
	public String getVdr_code_name() {
		return vdr_code_name;
	}

	public void setVdr_code_name(String vdr_code_name) {
		this.vdr_code_name = vdr_code_name;
	}
	...
	public void setVdr_name(String vdr_name) {
		this.vdr_name = vdr_name;
	}
