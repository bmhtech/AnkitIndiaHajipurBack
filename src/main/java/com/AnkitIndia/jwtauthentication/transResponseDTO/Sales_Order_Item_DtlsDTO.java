...
public class Sales_Order_Item_DtlsDTO {
	...
	public double getRatechartamt() {
		return ratechartamt;
	}

	public void setRatechartamt(double ratechartamt) {
		this.ratechartamt = ratechartamt;
	}

	public double getRatecharttol() {
		return ratecharttol;
	}

	public void setRatecharttol(double ratecharttol) {
		this.ratecharttol = ratecharttol;
	}

	public String getRateres() {
		return rateres;
	}

	public void setRateres(String rateres) {
