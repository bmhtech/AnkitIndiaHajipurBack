...
@Entity
@Table(name = "Stock_maintain", uniqueConstraints = {
        @UniqueConstraint(columnNames = {
                "business_unit","item_id","packing_id"
            })
    })
public class Stock_maintain {
	...
	public Stock_maintain(String business_unit,String warehouse,String stack_rack_no, String item_id, String packing_id,
			double standard_rate, double mrp, String item_type, String item_group, String item_category,
			String fin_year, String company_id, String username, String modified_type, LocalDateTime inserted_on,
			String inserted_by, LocalDateTime updated_on, String updated_by,double adv_packing_qty, double adv_item_qty, double rcv_packing_qty, double rcv_item_qty,
			double pssd_packing_qty, double pssd_item_qty) {
		super();
	...
	public String toString() {
		return "Stock_maintain [id=" + id + ", business_unit=" + business_unit + ", item_id=" + item_id + ", packing_id=" + packing_id + ", standard_rate=" + standard_rate + ", mrp=" + mrp
				+ ", item_type=" + item_type + ", item_group=" + item_group + ", item_category=" + item_category
				+ ", item_opening_stk=" + item_opening_stk + ", item_purchase_stk=" + item_purchase_stk
				+ ", item_pur_return=" + item_pur_return + ", item_sales_stk=" + item_sales_stk + ", item_sales_return="
				+ item_sales_return + ", item_stk_trans=" + item_stk_trans + ", item_trans_received="
				+ item_trans_received + ", item_curr_stk=" + item_curr_stk + ", item_close_stk=" + item_close_stk
				+ ", pack_opening_stk=" + pack_opening_stk + ", pack_purchase_stk=" + pack_purchase_stk
				+ ", pack_pur_return=" + pack_pur_return + ", pack_sales_stk=" + pack_sales_stk + ", pack_sales_return="
				+ pack_sales_return + ", pack_stk_trans=" + pack_stk_trans + ", pack_trans_received="
				+ pack_trans_received + ", pack_curr_stk=" + pack_curr_stk + ", pack_close_stk=" + pack_close_stk
