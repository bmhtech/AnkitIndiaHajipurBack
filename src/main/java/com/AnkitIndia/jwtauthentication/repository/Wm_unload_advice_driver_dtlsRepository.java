...
public interface Wm_unload_advice_driver_dtlsRepository extends JpaRepository<Wm_unload_advice_driver_dtls, Long>{
    ...
    int wm_unload_advice_driver_dtlsUpdate(@Param("unadviceid") String unadviceid);
	
	@Modifying(clearAutomatically = true)
    @Query("UPDATE Wm_unload_advice_driver_dtls w SET w.modified_type ='DELETED' WHERE w.unadviceid = :unadviceid")
    int wm_unload_advice_driver_dtlsupdate(@Param("unadviceid") String unadviceid);
}
