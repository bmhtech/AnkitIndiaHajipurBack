...
public interface Cust_bussiness_partner_shipping_addr_dtlsRepository extends JpaRepository<Cust_bussiness_partner_shipping_addr_dtls, Long>  
{
	...
	@Query(value="select * from cust_bussiness_partner_shipping_addr_dtls c where c.cp_Id = :mainid and shipping_name=:custid and c.modified_type = 'INSERTED'", nativeQuery=true)
	Map<String, Object> getCustomershipdtls(@Param("mainid") String mainid,@Param("custid") String custid);
