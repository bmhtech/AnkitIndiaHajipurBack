...
public interface Sales_Invoice_Item_DtlsRepository extends JpaRepository<Sales_Invoice_Item_Dtls, Long>{
	...
	@Query( value="SELECT s.*,CASE WHEN (a.party='CBP00001' OR a.party='CBP00002' OR a.party='CBP00006') THEN '10019910' ELSE s.hsn_code END AS hsnm_code,i.alt_name FROM sales_invoice_item_dtls s LEFT JOIN item_master i ON s.item_code=i.item_id\r\n" //hsn code hard core for itc
